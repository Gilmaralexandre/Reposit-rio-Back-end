...
email_origem = 'gilmar.alexandre.sc@gmail.com' #se alterar o email origem, é necessário alterar também a senha no arquivo "mail_password"
email_destino = ('gilmar.alexandre.sc@outlook.com')
...
anexo_path = "Engenharia_de_Software.pdf"
